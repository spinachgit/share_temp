...
import com.spinach.framework.sys.business.AbstractBusinessObject;
...
public class Template extends AbstractBusinessObject {
	...
	public Template(String name, String label, String description, String prePicBase, String prePicExt) {
		this.name = name;
		this.label = label;
	...
	public Collection<Layout> getLayouts() {
		return this.layouts == null ? new ArrayList<Layout>(0) : this.layouts.values();
	}

	public Collection<Theme> getThemes() {
		return this.themes == null ? new ArrayList<Theme>(0) : this.themes.values();
	}
	...
	public String getDefaultPicUrl() {
		String defaultPicUrl = this.getPrePicBase() + "/" + this.getDefaultLayout().getName() + "_" + this.getDefaultTheme().getName() + "_lg." + this.getPrePicExt();
	...
	public String getDefaultSmPicUrl() {
		String defaultSmPicUrl = this.getPrePicBase() + "/" + this.getDefaultLayout().getName() + "_" + this.getDefaultTheme().getName() + "_sm." + this.getPrePicExt();
