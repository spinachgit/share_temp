...
//
//	String STANDARD_PASSPORT_CLASS = "com.spinach.framework.core.passport.StandardPassport";

//	String X509_PASSPORT_CLASS = "com.spinach.framework.core.passport.X509Passport";

//	String AUTHENTICATOR_KEY = "passport.authentication-service.authenticator-class";
//
//	String DEFAULT_AUTHENTICATOR_CLASS = "com.spinach.framework.core.authentication.AuthenticatorImpl";
//
//	String CREDENTIAL_STORE_CLASS_KEY = "passport.authentication-service.credential-store";
//
//	String DB_CREDENTIAL_STORE_CLASS = "com.spinach.framework.core.authentication.store.db.DbCredentialStore";
//
//	String PRINCIPAL_STORE_KEY = "passport.authentication-service.principal-store";
//
//	String DB_PRINCIPAL_STORE_CLASS = "com.spinach.framework.core.authorization.store.db.DbPrincipalStore";
//
