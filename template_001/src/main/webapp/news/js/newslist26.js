	...
	$(document).ready(function(){
		...
		$("ul.newslist26").find("li").mouseover(function(){
			...
			$("ul.newslist26").find("http://localhost:8080/template_001/news/js/div.memo").hide();
			$("ul.newslist26").find("img").hide();
			$("ul.newslist26").find("http://localhost:8080/template_001/news/js/div.time").show();
			$(this).find("a").css({fontWeight:"bold"});
			$(this).find("http://localhost:8080/template_001/news/js/div.memo").show();
			$(this).find("img").show();
			$(this).find("http://localhost:8080/template_001/news/js/div.time").hide();
