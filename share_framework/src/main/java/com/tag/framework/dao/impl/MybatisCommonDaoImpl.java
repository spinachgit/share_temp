package com.tag.framework.dao.impl;
...
import com.tag.framework.dao.MybatisCommonDao;
 ...
 * 创建时间：2017-03-05 
 */  
public class MybatisCommonDaoImpl<T> {  
    ...
    public long executeAction(String sql) {  
        return mybatisCommonDao.executeAction(sql);  
    }  
    ...
    public Map<String, Object> findOneData(String sql) {  
        return mybatisCommonDao.findOneData(sql);  
    }  
    ...
    public List<Map<String, Object>> findManyData(String sql) {  
        return mybatisCommonDao.findManyData(sql);  
    }  
    ...
    public long findCount(String sql) {  
        return mybatisCommonDao.findCount(sql);  
    }  
    ...
    public Object findOneValue(String sql) {  
        return mybatisCommonDao.findOneValue(sql);  
    }  
    ...
    public long addClass(Class<T> entityName, Map<String, Object> addData) {  
        ...
        mybatisCommonDao.addEntity(params);  
        return params.getId();  
    }  
    ...
    public int batchAdd(Class<T> entityName, List<Map<String, Object>> listMap) {  
        ...
        return mybatisCommonDao.batchAdd(params);  
    }  
    ...
    public boolean updateByWhere(Class<T> entityName, Map<String , Object> updateData, String whereSql){  
        ...
        try {  
            ...
            bool = mybatisCommonDao.executeAction(sqlAppend(sb.toString(), updateData)) > 0;  
        } catch (Exception e) {  
            e.printStackTrace();  
        }  
        return bool;  
    ...
    public List<Map<String, Object>> getListByBean(Class<?> clazz) {  
        ...
        return mybatisCommonDao.findManyData(sql.toString());  
    }  
    ...
    public Map<String, Object> getByBean(Class<?> clazz) {  
        ...
        return mybatisCommonDao.findOneData(sql.toString());  
    }  
    ...
    public int batchDelete(Class<?> clazz, List<?> deleteList, String deleteColumnName) {  
        ...
        return mybatisCommonDao.batchDelete(params);  
    }  
}  